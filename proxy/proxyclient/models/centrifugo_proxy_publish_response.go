...
func (m *CentrifugoProxyPublishResponse) validateDisconnect(formats strfmt.Registry) error {
...
func (m *CentrifugoProxyPublishResponse) validateError(formats strfmt.Registry) error {
...
func (m *CentrifugoProxyPublishResponse) validateResult(formats strfmt.Registry) error {
...
func (m *CentrifugoProxyPublishResponse) contextValidateDisconnect(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxyPublishResponse) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxyPublishResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxyPublishResponse) UnmarshalBinary(b []byte) error {
	var res CentrifugoProxyPublishResponse
