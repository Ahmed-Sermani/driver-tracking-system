...
func (m *CentrifugoProxySubscribeResult) validateOverride(formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResult) contextValidateOverride(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResult) UnmarshalBinary(b []byte) error {
	var res CentrifugoProxySubscribeResult
