...
func (m *CentrifugoProxySubscribeResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CentrifugoProxySubscribeResponse) validateDisconnect(formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResponse) validateError(formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResponse) validateResult(formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResponse) contextValidateDisconnect(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResponse) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CentrifugoProxySubscribeResponse) UnmarshalBinary(b []byte) error {
	var res CentrifugoProxySubscribeResponse
