...
type ConnectParams struct {
	...
	// Body.
	Body *models.CentrifugoProxyConnectRequest
...
func (o *ConnectParams) WithBody(body *models.CentrifugoProxyConnectRequest) *ConnectParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the connect params
func (o *ConnectParams) SetBody(body *models.CentrifugoProxyConnectRequest) {
	o.Body = body
}
