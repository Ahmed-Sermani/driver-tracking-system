...
type SubscribeParams struct {
	...
	// Body.
	Body *models.CentrifugoProxySubscribeRequest
...
func (o *SubscribeParams) WithBody(body *models.CentrifugoProxySubscribeRequest) *SubscribeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the subscribe params
func (o *SubscribeParams) SetBody(body *models.CentrifugoProxySubscribeRequest) {
	o.Body = body
}
