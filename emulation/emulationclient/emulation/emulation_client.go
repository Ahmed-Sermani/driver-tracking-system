...
// New creates a new emulation API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for emulation API
*/
type Client struct {
...
/*
Start starts publishing message on the target channel
*/
func (a *Client) Start(params *StartParams, opts ...ClientOption) (*StartOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "start",
		Method:             "POST",
		PathPattern:        "/api/emulation/start",
	...
	unexpectedSuccess := result.(*StartDefault)
